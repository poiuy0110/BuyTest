<nav class="navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-item nav-link" href="{{ route('admin.home.edit') }}">訂單管理</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <li><a class="nav-item nav-link" href="{{ route('admin.store.edit') }}">賣家管理</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    商品管理    
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.home.edit') }}">首頁輪播圖</a>
                    <a class="dropdown-item" href="{{ route('admin.home.edit') }}">發票號碼設定</a>
                    <a class="dropdown-item" href="{{ route('admin.home.edit') }}">常見問題</a>
                    <a class="dropdown-item" href="{{ route('admin.home.edit') }}">參數設定</a>  
                </div>
            </li>
            <li class="nav-item">
                <li><a class="nav-item nav-link" href="{{ route('admin.store.edit') }}">使用者管理</a>
            </li>
          </ul>
